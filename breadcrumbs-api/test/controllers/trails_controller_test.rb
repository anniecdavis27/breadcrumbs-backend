...
class TrailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post trails_url, params: { trail: { endLat: @trail.endLat, endLng: @trail.endLng, startLat: @trail.startLat, startLng: @trail.startLng } }, as: :json
    end
  ...
  test "should update trail" do
    patch trail_url(@trail), params: { trail: { endLat: @trail.endLat, endLng: @trail.endLng, startLat: @trail.startLat, startLng: @trail.startLng } }, as: :json
    assert_response 200
  end
